...
for variable in df.columns[1:]:
    ...
    plt.plot(range(2024, 2029), holt_forecasts[variable], label=f'{variable} (HOLT Forecast)')
    plt.plot(range(2024, 2029), arima_forecasts[variable], label=f'{variable} (ARIMA Forecast)')
